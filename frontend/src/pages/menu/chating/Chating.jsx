    ...
    try {
      ...
      if (res.ok) {
        ...
        console.log('Data is array:', Array.isArray(json.data));
             ...
             console.log('Number of participants before filtering:', json.data.length);
               ...
               console.log(`Current user ID: ${currentUserId} -> parsed: ${currentUserIdNum}`);
               console.log(`Participant user ID: ${participantUserId} -> parsed: ${participantUserIdNum}`);
               console.log(`Comparison: ${participantUserIdNum} !== ${currentUserIdNum} = ${participantUserIdNum !== currentUserIdNum}`);
            ...
            console.log('Number of participants after filtering:', filteredParticipants.length);
         ...
         try {
           ...
           if (data?.type === "chat_message") {
             ...
             if (chatMode === 'global') {
               ...
               console.log('Global mode: message has userReceiveId?', !!data.userReceiveId, 'should add:', shouldAddMessage);
               ...
               const isFromSelectedParticipant = data.userId === selectedParticipant.userId;
               const isToSelectedParticipant = data.userReceiveId === selectedParticipant.userId;
               const isFromCurrentUser = data.userId === user?.id;
               const isToCurrentUser = data.userReceiveId === user?.id;
               
               shouldAddMessage = (isFromSelectedParticipant && isToCurrentUser) || 
                                (isFromCurrentUser && isToSelectedParticipant);
               
               console.log('Private mode: from selected?', isFromSelectedParticipant, 'to current?', isToCurrentUser, 'should add:', shouldAddMessage);
             }
